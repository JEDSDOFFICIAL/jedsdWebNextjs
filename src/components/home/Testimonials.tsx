  ...
  return (
    <div className="overflow-hidden">
      <div className="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="flex h-auto">
            <div className="flex flex-col bg-[rgb(39,59,90)] rounded-xl">
              ...
              <div className="p-4 bg-[rgb(39,59,90)] rounded-b-xl md:px-7">
                <div className="flex items-center gap-x-3">
                  ...
                  <div className="grow border-t border-gray-800 pt-3">
        ...
        <div className="mt-5 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-400">partner with JEDSD</p>
          </div>
